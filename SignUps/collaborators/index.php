...
<body class="bg-black text-white min-h-screen flex flex-col relative">
  ...
  <header class="py-6 px-8 flex justify-between items-center relative z-10">
    ...
    <a href="../login/index.php">
      <span class="text-pink-500 flex items-center">Log In</span>
    </a>
  </header>
      ...
      <div class="bg-gradient-to-br from-gray-900 to-black backdrop-blur-sm rounded-xl p-8 shadow-lg border border-gray-800">
        ...
        <form id="signupForm" class="space-y-6" action="../../config/addCollaborator.php" method="POST">
          ...
          <div>
            ...
            <input type="text" name="preferences" id="preferences" class="bg-gradient-to-br from-gray-900 to-black border border-gray-700 rounded-lg w-full px-4 py-3 focus:outline-none focus:ring-2 focus:ring-pink-500"
              placeholder="Enter your preferences" />
          </div>

          <div class="flex items-center">
            <input type="checkbox" id="terms" class="w-4 h-4 bg-gradient-to-br from-graybg-gradient-to-br from-gray-900 to-border border-gray-700 hover:border-gray-500  transition duration-800  cursor-pointer focus:ring-pink-500"
              required />
        ...
        <div class="mt-8 pt-6 border-t border-gray-800">
          ...
          <div class="grid grid-cols-3 gap-4">
            <button
              class="py-3 px-4 bg-gradient-to-br from-gray-900 to-black border border-gray-700 hover:border-gray-500  transition duration-800  cursor-pointer text-white font-medium rounded-lg flex items-center justify-center">
