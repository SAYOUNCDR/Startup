            ...
            <div class="flex flex-col md:flex-row items-center justify-between md:space-x-12 lg:space-x-16">
                ...
                <div class="md:w-1/2 mb-8 md:mb-0">
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-white">
                        Fueling
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-600">Startups</span>
                ...
                <div class="md:w-1/2">
                    <div class="rounded-lg overflow-hidden shadow-2xl">
                        <img src="../../Images/events-05.jpg" alt="Startup collaboration" class="w-full h-full object-cover border border-gray-600" />
                    </div>
                </div>
            </div>
        </div>
